            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
                ...
                <div class="lg:col-span-9">
                    ...
                    <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 md:p-8 shadow-sm">
                        ...
                        <div class="prose dark:prose-invert max-w-none prose-img:rounded-xl prose-a:text-rose-600 hover:prose-a:text-rose-700">
                            ...
                            <ul class="list-disc list-inside space-y-2 mb-6 marker:text-rose-600">
