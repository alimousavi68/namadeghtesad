                ...
                <article class="lg:col-span-9 print:w-full">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6 print:hidden">
                        ...
                        <div class="flex items-center gap-3 order-2 md:order-2 md:justify-end">
                            ...
                            <a href="<?php echo esc_url('https://eitaa.com/share/url?url=' . $share_url . '&text=' . $share_title); ?>" class="flex items-center justify-center w-10 h-10 rounded-full border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-500 dark:text-slate-400 hover:bg-white hover:border-primary hover:text-primary dark:hover:bg-slate-900 dark:hover:border-primary dark:hover:text-primary transition-all duration-300" title="ایتا" target="_blank" rel="noopener noreferrer">
