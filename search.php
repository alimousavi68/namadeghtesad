        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            <div class="lg:col-span-8 bg-white rounded-xl shadow-sm border border-gray-100 p-6 md:p-8">
                <div class="flex items-center gap-2 text-xs text-gray-500 mb-4">
                    ...
                    <span>/</span>
                    <span class="font-bold text-gray-800">نتایج جستجو</span>
                </div>

                <h1 class="text-2xl md:text-3xl font-bold text-gray-900 mb-2 leading-tight">
                    نتایج جستجو برای: <span class="text-blue-600"><?php echo esc_html(get_search_query()); ?></span>
                </h1>
                ...
                <div class="mt-2 mb-6 flex items-center justify-between">
                    <span class="text-xs text-gray-500">تعداد نتایج: <?php echo absint($wp_query->found_posts); ?></span>
                    <span class="text-xs text-gray-400">کلمه جستجو: <?php echo esc_html(get_search_query()); ?></span>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
                    ...
                    <?php endwhile; else: ?>
                        <p class="text-gray-500 text-sm">نتیجه‌ای مطابق جستجو یافت نشد.</p>
                    <?php endif; ?>
                </div>
